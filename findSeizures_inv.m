function seizures = findSeizures_inv(varargin)%pband, ptCut, ttv, eegChannel, targetFS)
%% findSeizures_inv Finds seizures in INVERTED EEG/LFP traces based on power thresholding in 2nd harmonic
%
% INPUTS:
%   %----------------------Name-Value-Pairs----------------------%
